...
def main():
    ...
    parser.add_argument('--model', default="unet_5fold", required=False,
                        help='Model name.')
    parser.add_argument('--gpu', type=int, nargs='+', default=[0], required=False,
                        help='Device id.')
    parser.add_argument('--log_folder',default="/app/JiangJiaxuan/Segmentation/pixel-level/deeplearning/log/5fold-Base3" ,required=False,
                        help='Log folder.')
    ...
    parser.add_argument('--tr_csv', nargs='+',
                        default=["/app/JiangJiaxuan/Segmentation/Hopkins/ccsdg/data/MESSIDOR_Base3_train.csv",
                                 "/app/JiangJiaxuan/Segmentation/Hopkins/ccsdg/data/MESSIDOR_Base3_test.csv"],required=False, help='training csv file.')
    parser.add_argument('--ts_csv', nargs='+',
                        default=["/app/JiangJiaxuan/Segmentation/Hopkins/ccsdg/data/MESSIDOR_Base1_train.csv",
                                 ...
                                 "/app/JiangJiaxuan/Segmentation/Hopkins/ccsdg/data/MESSIDOR_Base3_train.csv",
    ...
    #now_seed = args.seed
    now_seed = 42
    args.tag = f"FiveFold_Base3_42"
    #args.tag = "Test"

    if model_name == 'unet':
        from deeplearning.training.train_nets.train_unet import train
    elif model_name == 'unet_ccsdg':
        from deeplearning.training.train_nets.train_unet_ccsdg import train 
    elif model_name == 'unet_pcsdg':
        from deeplearning.training.train_nets.train_unet_pcsdg import train
    elif model_name == 'unet_pcsdg_simple':
        from deeplearning.training.train_nets.train_unet_pcsdg_simple import train
    elif model_name == 'unet_pcsdg_simple_mseLoss':
        from deeplearning.training.train_nets.train_unet_pcsdg_simple_mseLoss import train
    elif model_name == 'unet_pcsdg_simple_SABA':
        from deeplearning.training.train_nets.train_unet_pcsdg_simple_SABA import train
    elif model_name == 'pcsdg_SABA_hd95':
        from deeplearning.training.train_nets.train_pcsdg_SABA_hd95 import train
    elif model_name == 'unet_5fold':
        from deeplearning.training.train_nets.train_unet_five_fold import train
    else:
